...
const CliSessionsSettings = React.lazy(() => import('@renderer/pages/settings/CliSessionsSettings'));
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route path='/settings/cli-sessions' element={withRouteFallback(CliSessionsSettings)} />
